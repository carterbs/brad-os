...
describe('Health Sync Handler', () => {
  ...
  describe('POST /weight', () => {
    it('should create a single weight entry with explicit source', async () => {
      ...
      expect(mockRecoveryService.addWeightEntry).toHaveBeenCalledWith(
        'default-user',
        {
          weightLbs: 180.5,
          date: '2026-02-09',
    ...
    it('should default source to manual when omitted', async () => {
      mockRecoveryService.addWeightEntry.mockResolvedValue({
        id: '2026-02-09',
        date: '2026-02-09',
        weightLbs: 180,
    ...
    it('should reject missing weight field', async () => {
      const response = await request(healthSyncApp).post('/weight').send({
        date: '2026-02-09',
      });
    ...
    it('should return 500 via error handler when service throws', async () => {
      mockRecoveryService.addWeightEntry.mockRejectedValueOnce(new Error('DB failed'));
  ...
  describe('GET /recovery/history', () => {
    ...
    it('should clamp days=0 to 1', async () => {
      ...
      await request(healthSyncApp).get('/recovery/history?days=0');
